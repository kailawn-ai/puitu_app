...
const SkeletonInput = () => (
  <View className="mt-2 h-14 rounded-2xl border border-border bg-white dark:border-gray-700 dark:bg-secondary-900" />
);
    ...
    <View className="flex-1 animate-pulse">
      ...
      >
        ...
        >
          ...
          <View className="h-7 w-36 rounded-full bg-gray-200 dark:bg-gray-700" />
        ...
        <View className="mt-4 px-5">
          ...
          <View className="mt-5 rounded-3xl bg-gray-200 p-5 dark:bg-secondary-700">
            ...
            <View className="mt-4 flex-row flex-wrap">
              {[1, 2, 3].map((item) => (
                <View
                  ...
                  style={{ width: item === 2 ? 138 : 116 }}
                />
              ))}
            </View>

            <View className="mt-4 h-14 rounded-2xl border border-dashed border-primary-200 bg-white dark:border-primary-700 dark:bg-secondary-900" />
          </View>
        </View>
